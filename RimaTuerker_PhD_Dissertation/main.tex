...
\input{cha_introduction}
%\input{cha_foundations_introduction}
\input{cha_foundations_basics}
\input{cha_foundations_text_cat}
\input{cha_kbstc}
%\input{cha_kb_text_cat}
\input{cha_weakly_supervised_cat}
%\input{cha_patent_class}
\input{cha_conclusions_conclusions}
%\input{part_appendix}
%********************************************************
\backmatter
%********************************************************
